...
p[0].parentNode.parentNode.style.border = '5px solid #000'
//노드 복제(복제->반복사용 위치 붙여넣기)
console.log(p[2].parentNode.cloneNode()) //대상만 복제
console.log(p[2].parentNode.cloneNode(true)) //대상포함 대상의 자식, 자손 복제
...
DOM.parentNode.cloneNode() 부모 복제(자식,자손 포함x)
